...
function createSuggestionRow() {
  ...
  row.style.cssText = "display: flex;flex-direction: row;justify-content: space-between;";
  return row;
}
...
export { createSingleWordDiv, createImgDiv, createEmptyDiv, createErrorDiv, createSuggestionColumn, createSuggestionRow, createMeasureDiv, getImg };
